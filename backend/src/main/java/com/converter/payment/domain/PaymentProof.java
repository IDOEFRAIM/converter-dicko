...
/**
 * Metadonnees d'une preuve de paiement. Aucun contenu binaire en base
 * — voir {@link com.converter.storage.FileStorageService}.
 */
@Entity
...
public class PaymentProof extends BaseEntity {
    ...
    public PaymentProof(UUID paymentId, String fileName, String contentType, String storageKey,
