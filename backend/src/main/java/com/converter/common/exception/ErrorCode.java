...
public enum ErrorCode {
    ...
    INVALID_WEBHOOK_SIGNATURE(HttpStatus.UNAUTHORIZED, Category.AUTHENTICATION_ERROR),
    ...
    TRANSFI_ORDER_ALREADY_ROUTED(HttpStatus.CONFLICT, Category.BUSINESS_ERROR),
    ...
    PUSH_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, Category.BUSINESS_ERROR),
    TRANSFI_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, Category.BUSINESS_ERROR);
